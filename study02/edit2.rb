...
first_segment = last_segments.shift
last_segments.inject(first_segment){|r, b| r + b} > "_results/edit2.#{Time.now.to_i}.wav"
puts "end"


__END__

[8] pry(main)> info[:segments].length
=> 674
[9] pry(main)> info[:bars].length
=> 51
[10] pry(main)> info[:beats].length
=> 209
